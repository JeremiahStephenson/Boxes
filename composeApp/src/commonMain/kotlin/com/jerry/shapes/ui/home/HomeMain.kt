...
fun HomeMain(
    ...
    DefaultContainer(
        ...
        LaunchedEffect(Unit) {
            viewModel.showOnboarding.collectLatest {
                if (it) {
                    navigator.navigate(CreateNavKey())
        ...
        if (areItemsEmpty) {
            Column(
                ...
                Image(
                    ...
                    painter = painterResource(Res.drawable.puppy),
    ...
    Card {
        Column(
            ...
            if (showConfirmationDialog) {
                AreYouSureDialog(
                    title = stringResource(Res.string.are_you_sure_project, item.name),
...
private fun EditMenu(
    ...
    Text(
        ...
        text =
            stringResource(
                when (editMode) {
                    true -> Res.string.done
                    else -> Res.string.edit
                },
            ),
    )
}
